...
--changeset patcher-core:ERJGetQueue dbms:postgresql runOnChange:true splitStatements:false stripComments:false
INSERT INTO s_mt.t_query (ck_id, ck_provider, ck_user, ct_change, cr_type, cr_access, cn_action, cv_description, cc_query)
 VALUES('ERJGetQueue', 'er_api', '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2024-09-06T20:48:09.328+0300', 'dml', 'po_session', null, 'Список очереди',
 '
v = {
    method: ''POST'',
