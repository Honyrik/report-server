...
--changeset patcher-core:ERJGetDStatus dbms:postgresql runOnChange:true splitStatements:false stripComments:false
INSERT INTO s_mt.t_query (ck_id, ck_provider, ck_user, ct_change, cr_type, cr_access, cn_action, cv_description, cc_query)
 VALUES('ERJGetDStatus', 'er_api', '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2024-09-04T16:51:19.115+0300', 'dml', 'po_session', null, 'Список статусов',
 'v = {
    method: ''POST'',
    url: `${jt_provider_params.defaultGateUrl}/admin/dictionary/DStatus?session=${jt_in_param.sess_session}`,
    json: { 
