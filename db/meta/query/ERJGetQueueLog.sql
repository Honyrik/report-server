...
--changeset patcher-core:ERJGetQueueLog dbms:postgresql runOnChange:true splitStatements:false stripComments:false
INSERT INTO s_mt.t_query (ck_id, ck_provider, ck_user, ct_change, cr_type, cr_access, cn_action, cv_description, cc_query)
 VALUES('ERJGetQueueLog', 'er_api', '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2024-09-06T20:52:37.015+0300', 'dml', 'po_session', null, 'Список ошибок',
 '
v = {
    method: ''POST'',
    url: `${jt_provider_params.defaultGateUrl}/admin/QueueLog?session=${jt_in_param.sess_session}`,
    json: { 
        data: Object.assign(jt_in_param.json.filter, {queue:{ckId: jt_in_param.json.master.ckId}}),
