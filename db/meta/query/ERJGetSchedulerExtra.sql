...
--changeset patcher-core:ERJGetSchedulerExtra dbms:postgresql runOnChange:true splitStatements:false stripComments:false
INSERT INTO s_mt.t_query (ck_id, ck_provider, ck_user, ct_change, cr_type, cr_access, cn_action, cv_description, cc_query)
 VALUES('ERJGetSchedulerExtra', 'er_api', '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2024-09-05T19:03:34.918+0300', 'dml', 'po_session', null, 'Список планировщика с настройками',
 'v = {
    method: ''POST'',
    url: `${jt_provider_params.defaultGateUrl}/admin/Scheduler?session=${jt_in_param.sess_session}`,
    json: { 
