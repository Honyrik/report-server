...
--changeset patcher-core:ERJGetReport dbms:postgresql runOnChange:true splitStatements:false stripComments:false
INSERT INTO s_mt.t_query (ck_id, ck_provider, ck_user, ct_change, cr_type, cr_access, cn_action, cv_description, cc_query)
 VALUES('ERJGetReport', 'er_api', '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2024-09-05T12:30:32.678+0300', 'dml', 'po_session', null, 'Список отчетов',
 '
v = {
    method: ''POST'',
