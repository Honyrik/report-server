...
@Slf4j
public class JRRTFExporter implements JasperFormatExporter {
    public final String name;
    private final Map<String, Object> param;
    private TDFormat data;
    public JRRTFExporter(TDFormat format, Map<String, Object> param) {
    ...
    public byte[] export(JasperPrint jasperPrint, TQueue queue) {
        try {
            ...
            var configuration = Util.objectMapper.convertValue(property, SimpleRtfExporterConfiguration.class);
