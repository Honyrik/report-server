...
@Slf4j
public class JRCSVExporter implements JasperFormatExporter {
    public final String name;
    private final Map<String, Object> param;
    private TDFormat data;
    public JRCSVExporter(TDFormat format, Map<String, Object> param) {
    ...
    public byte[] export(JasperPrint jasperPrint, TQueue queue) {
        try {
            ...
            var configuration = Util.objectMapper.convertValue(property, SimpleCsvExporterConfiguration.class);
