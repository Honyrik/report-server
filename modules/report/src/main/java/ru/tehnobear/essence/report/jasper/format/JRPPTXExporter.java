...
@Slf4j
public class JRPPTXExporter implements JasperFormatExporter {
    public final String name;
    private final Map<String, Object> param;
    private TDFormat data;
    public JRPPTXExporter(TDFormat format, Map<String, Object> param) {
    ...
    public byte[] export(JasperPrint jasperPrint, TQueue queue) {
        try {
            ...
            var configuration = Util.objectMapper.convertValue(property, SimplePptxExporterConfiguration.class);
