...
@Slf4j
public class JRODTExporter implements JasperFormatExporter {
    public final String name;
    private final Map<String, Object> param;
    private TDFormat data;
    public JRODTExporter(TDFormat format, Map<String, Object> param) {
    ...
    public byte[] export(JasperPrint jasperPrint, TQueue queue) {
        try {
            ...
            var configuration = Util.objectMapper.convertValue(property, SimpleOdtExporterConfiguration.class);
